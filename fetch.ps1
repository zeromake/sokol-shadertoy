...
-Headers @{
  "Referer" = "https://www.shadertoy.com/view/cdjyzh"
} `
-ContentType "application/x-www-form-urlencoded" `
-Body "s=%7B%20%22shaders%22%20%3A%20%5B%22cdjyzh%22%5D%20%7D&nt=1&nl=1&np=1"

$conf = $resp.Content | ConvertFrom-Json
$code = $conf[0].renderpass[0].code
echo $code | Out-File -Encoding utf8 -FilePath 1.glsl
